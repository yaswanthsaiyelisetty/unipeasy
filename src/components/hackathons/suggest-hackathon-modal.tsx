...
interface SuggestHackathonModalProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export function SuggestHackathonModal({ open, onOpenChange }: SuggestHackathonModalProps) {
    const { user } = useAuth();
    ...
    const validateForm = () => {
        ...
        if (!formData.link.trim()) {
            newErrors.link = "Registration link is required";
        } else {
            try {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await addDoc(collection(db, "hackathon_suggestions"), {
            ...
            toast({
                ...
                description: "Thank you for helping fellow students find hackathons!",
            });
                ...
                <AnimatePresence mode="wait">
                    {submitted ? (
                        ...
                        >
                            ...
                            <div className="relative bg-gradient-to-r from-violet-500/10 via-purple-500/10 to-fuchsia-500/10 px-6 pt-6 pb-4 border-b">
                                ...
                                <DialogHeader className="relative">
                                    <div className="flex items-center gap-3 mb-2">
                                        ...
                                        <DialogTitle className="text-xl">Suggest a Hackathon</DialogTitle>
                                    </div>
                                    <DialogDescription className="text-sm">
                                        Found a hackathon opportunity? Share it with fellow students!
                            ...
                            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Textarea
                                        id="description"
                                        placeholder="Brief description, theme, prizes, or any helpful info..."
                                ...
                                <div className="flex gap-3 pt-2">
                                    ...
                                    <Button
                                        type="submit"
                                        disabled={isSubmitting}
                                        className="flex-1 bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white shadow-lg shadow-violet-500/25 gap-2"
                                    >
                                        {isSubmitting ? (
                                            <>
