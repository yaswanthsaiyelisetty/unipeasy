      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          <Link href="/about" className="group">
            <div className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-primary/5 via-purple-500/5 to-primary/5 border border-primary/10 hover:border-primary/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5">
              <div className="flex items-center gap-2">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-primary to-purple-500 rounded-full blur-sm opacity-50 group-hover:opacity-75 transition-opacity" />
                  <div className="relative p-1.5 rounded-full bg-gradient-to-r from-primary to-purple-500">
          ...
          <p className="text-xs text-muted-foreground text-center max-w-md">
            Built with ❤️ by students, for students • Making learning easier, one topic at a time
          </p>
        </div>
